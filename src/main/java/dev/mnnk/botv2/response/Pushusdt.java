...
public class Pushusdt {
    ...
    public Pushusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Pushusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Pushusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Pushusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Pushusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Pushusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Pushusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Pushusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Pushusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Pushusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Pushusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Pushusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Pushusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Pushusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pushusdt) == false) {
            return false;
        }
        Pushusdt rhs = ((Pushusdt) other);

...
public class Bnbinr {
    ...
    public Bnbinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Bnbinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Bnbinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Bnbinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Bnbinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Bnbinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Bnbinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Bnbinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Bnbinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Bnbinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Bnbinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Bnbinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Bnbinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Bnbinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bnbinr) == false) {
            return false;
        }
        Bnbinr rhs = ((Bnbinr) other);

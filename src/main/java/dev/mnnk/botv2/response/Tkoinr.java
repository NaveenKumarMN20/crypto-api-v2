...
public class Tkoinr {
    ...
    public Tkoinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Tkoinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Tkoinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Tkoinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Tkoinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Tkoinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Tkoinr withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Tkoinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Tkoinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Tkoinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Tkoinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Tkoinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Tkoinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Tkoinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tkoinr) == false) {
            return false;
        }
        Tkoinr rhs = ((Tkoinr) other);

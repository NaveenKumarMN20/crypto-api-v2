...
public class Creamusdt {
    ...
    public Creamusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Creamusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Creamusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Creamusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Creamusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Creamusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Creamusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Creamusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Creamusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Creamusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Creamusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Creamusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Creamusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Creamusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Creamusdt) == false) {
            return false;
        }
        Creamusdt rhs = ((Creamusdt) other);

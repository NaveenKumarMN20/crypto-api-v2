...
public class Ankrusdt {
    ...
    public Ankrusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ankrusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ankrusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ankrusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ankrusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ankrusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ankrusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Ankrusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ankrusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ankrusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ankrusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ankrusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ankrusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ankrusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ankrusdt) == false) {
            return false;
        }
        Ankrusdt rhs = ((Ankrusdt) other);

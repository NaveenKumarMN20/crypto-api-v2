...
public class Busdinr {
    ...
    public Busdinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Busdinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Busdinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Busdinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Busdinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Busdinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Busdinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Busdinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Busdinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Busdinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Busdinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Busdinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Busdinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Busdinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Busdinr) == false) {
            return false;
        }
        Busdinr rhs = ((Busdinr) other);

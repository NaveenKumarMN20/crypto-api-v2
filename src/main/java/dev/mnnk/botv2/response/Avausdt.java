...
public class Avausdt {
    ...
    public Avausdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Avausdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Avausdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Avausdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Avausdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Avausdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Avausdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Avausdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Avausdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Avausdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Avausdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Avausdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Avausdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Avausdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Avausdt) == false) {
            return false;
        }
        Avausdt rhs = ((Avausdt) other);

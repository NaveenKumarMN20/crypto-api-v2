...
public class Kmdinr {
    ...
    public Kmdinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Kmdinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Kmdinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Kmdinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Kmdinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Kmdinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Kmdinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Kmdinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Kmdinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Kmdinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Kmdinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Kmdinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Kmdinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Kmdinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Kmdinr) == false) {
            return false;
        }
        Kmdinr rhs = ((Kmdinr) other);

...
public class Atomusdt {
    ...
    public Atomusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Atomusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Atomusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Atomusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Atomusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Atomusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Atomusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Atomusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Atomusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Atomusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Atomusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Atomusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Atomusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Atomusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Atomusdt) == false) {
            return false;
        }
        Atomusdt rhs = ((Atomusdt) other);

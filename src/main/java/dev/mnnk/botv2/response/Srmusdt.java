...
public class Srmusdt {
    ...
    public Srmusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Srmusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Srmusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Srmusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Srmusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Srmusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Srmusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Srmusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Srmusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Srmusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Srmusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Srmusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Srmusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Srmusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Srmusdt) == false) {
            return false;
        }
        Srmusdt rhs = ((Srmusdt) other);

...
public class Filusdt {
    ...
    public Filusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Filusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Filusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Filusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Filusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Filusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Filusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Filusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Filusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Filusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Filusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Filusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Filusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Filusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Filusdt) == false) {
            return false;
        }
        Filusdt rhs = ((Filusdt) other);

...
public class Yfiusdt {
    ...
    public Yfiusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Yfiusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Yfiusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Yfiusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Yfiusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Yfiusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Yfiusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Yfiusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Yfiusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Yfiusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Yfiusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Yfiusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Yfiusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Yfiusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Yfiusdt) == false) {
            return false;
        }
        Yfiusdt rhs = ((Yfiusdt) other);

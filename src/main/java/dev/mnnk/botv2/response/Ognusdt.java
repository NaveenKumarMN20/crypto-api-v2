...
public class Ognusdt {
    ...
    public Ognusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ognusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ognusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ognusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ognusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ognusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ognusdt withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Ognusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ognusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ognusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ognusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ognusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ognusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ognusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ognusdt) == false) {
            return false;
        }
        Ognusdt rhs = ((Ognusdt) other);

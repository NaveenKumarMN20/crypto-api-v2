...
public class Xlminr {
    ...
    public Xlminr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Xlminr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Xlminr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Xlminr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Xlminr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Xlminr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Xlminr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Xlminr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Xlminr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Xlminr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Xlminr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Xlminr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Xlminr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Xlminr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Xlminr) == false) {
            return false;
        }
        Xlminr rhs = ((Xlminr) other);

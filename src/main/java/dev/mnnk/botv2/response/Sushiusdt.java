...
public class Sushiusdt {
    ...
    public Sushiusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Sushiusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Sushiusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Sushiusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Sushiusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Sushiusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Sushiusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Sushiusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Sushiusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Sushiusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Sushiusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Sushiusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Sushiusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sushiusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sushiusdt) == false) {
            return false;
        }
        Sushiusdt rhs = ((Sushiusdt) other);

...
public class Sandusdt {
    ...
    public Sandusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Sandusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Sandusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Sandusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Sandusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Sandusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Sandusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Sandusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Sandusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Sandusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Sandusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Sandusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Sandusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sandusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sandusdt) == false) {
            return false;
        }
        Sandusdt rhs = ((Sandusdt) other);

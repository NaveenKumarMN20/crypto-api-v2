...
public class Pushinr {
    ...
    public Pushinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Pushinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Pushinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Pushinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Pushinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Pushinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Pushinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Pushinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Pushinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Pushinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Pushinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Pushinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Pushinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Pushinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pushinr) == false) {
            return false;
        }
        Pushinr rhs = ((Pushinr) other);

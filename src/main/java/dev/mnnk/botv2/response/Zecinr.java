...
public class Zecinr {
    ...
    public Zecinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Zecinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Zecinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Zecinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Zecinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Zecinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Zecinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Zecinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Zecinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Zecinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Zecinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Zecinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Zecinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Zecinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Zecinr) == false) {
            return false;
        }
        Zecinr rhs = ((Zecinr) other);

...
public class Iostinr {
    ...
    public Iostinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Iostinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Iostinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Iostinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Iostinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Iostinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Iostinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Iostinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Iostinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Iostinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Iostinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Iostinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Iostinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Iostinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Iostinr) == false) {
            return false;
        }
        Iostinr rhs = ((Iostinr) other);

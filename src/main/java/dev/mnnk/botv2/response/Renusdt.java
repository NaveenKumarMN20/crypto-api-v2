...
public class Renusdt {
    ...
    public Renusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Renusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Renusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Renusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Renusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Renusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Renusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Renusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Renusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Renusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Renusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Renusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Renusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Renusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Renusdt) == false) {
            return false;
        }
        Renusdt rhs = ((Renusdt) other);

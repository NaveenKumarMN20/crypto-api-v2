...
public class Tomousdt {
    ...
    public Tomousdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Tomousdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Tomousdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Tomousdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Tomousdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Tomousdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Tomousdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Tomousdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Tomousdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Tomousdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Tomousdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Tomousdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Tomousdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Tomousdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tomousdt) == false) {
            return false;
        }
        Tomousdt rhs = ((Tomousdt) other);

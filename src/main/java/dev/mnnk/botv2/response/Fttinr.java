...
public class Fttinr {
    ...
    public Fttinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Fttinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Fttinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Fttinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Fttinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Fttinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Fttinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Fttinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Fttinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Fttinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Fttinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Fttinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Fttinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Fttinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fttinr) == false) {
            return false;
        }
        Fttinr rhs = ((Fttinr) other);

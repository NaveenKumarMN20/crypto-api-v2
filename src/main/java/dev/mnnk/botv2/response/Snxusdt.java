...
public class Snxusdt {
    ...
    public Snxusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Snxusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Snxusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Snxusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Snxusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Snxusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Snxusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Snxusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Snxusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Snxusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Snxusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Snxusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Snxusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Snxusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Snxusdt) == false) {
            return false;
        }
        Snxusdt rhs = ((Snxusdt) other);

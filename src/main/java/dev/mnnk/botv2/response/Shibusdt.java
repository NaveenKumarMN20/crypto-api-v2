...
public class Shibusdt {
    ...
    public Shibusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Shibusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Shibusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Shibusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Shibusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Shibusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Shibusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Shibusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Shibusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Shibusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Shibusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Shibusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Shibusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Shibusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shibusdt) == false) {
            return false;
        }
        Shibusdt rhs = ((Shibusdt) other);

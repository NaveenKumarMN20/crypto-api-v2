...
public class Enjwrx {
    ...
    public Enjwrx withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Enjwrx withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Enjwrx withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Enjwrx withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Enjwrx withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Enjwrx withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Enjwrx withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Enjwrx withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Enjwrx withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Enjwrx withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Enjwrx withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Enjwrx withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Enjwrx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Enjwrx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Enjwrx) == false) {
            return false;
        }
        Enjwrx rhs = ((Enjwrx) other);

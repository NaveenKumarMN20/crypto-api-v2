...
public class Ezusdt {
    ...
    public Ezusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ezusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ezusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ezusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ezusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ezusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ezusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Ezusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ezusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ezusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ezusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ezusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ezusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ezusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ezusdt) == false) {
            return false;
        }
        Ezusdt rhs = ((Ezusdt) other);

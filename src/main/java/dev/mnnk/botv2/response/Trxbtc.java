...
public class Trxbtc {
    ...
    public Trxbtc withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Trxbtc withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Trxbtc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Trxbtc) == false) {
            return false;
        }
        Trxbtc rhs = ((Trxbtc) other);

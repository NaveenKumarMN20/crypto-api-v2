...
public class Cotiinr {
    ...
    public Cotiinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Cotiinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Cotiinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Cotiinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Cotiinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Cotiinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Cotiinr withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Cotiinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Cotiinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Cotiinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Cotiinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Cotiinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Cotiinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Cotiinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cotiinr) == false) {
            return false;
        }
        Cotiinr rhs = ((Cotiinr) other);

...
public class Wtcusdt {
    ...
    public Wtcusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Wtcusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Wtcusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Wtcusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Wtcusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Wtcusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Wtcusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Wtcusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Wtcusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Wtcusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Wtcusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Wtcusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Wtcusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Wtcusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Wtcusdt) == false) {
            return false;
        }
        Wtcusdt rhs = ((Wtcusdt) other);

...
public class Oneinr {
    ...
    public Oneinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Oneinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Oneinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Oneinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Oneinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Oneinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Oneinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Oneinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Oneinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Oneinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Oneinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Oneinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Oneinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Oneinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Oneinr) == false) {
            return false;
        }
        Oneinr rhs = ((Oneinr) other);

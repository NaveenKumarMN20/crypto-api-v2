...
public class Bandusdt {
    ...
    public Bandusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Bandusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Bandusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Bandusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Bandusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Bandusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Bandusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Bandusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Bandusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Bandusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Bandusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Bandusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Bandusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Bandusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bandusdt) == false) {
            return false;
        }
        Bandusdt rhs = ((Bandusdt) other);

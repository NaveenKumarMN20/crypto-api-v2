...
public class Zrxinr {
    ...
    public Zrxinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Zrxinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Zrxinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Zrxinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Zrxinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Zrxinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Zrxinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Zrxinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Zrxinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Zrxinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Zrxinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Zrxinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Zrxinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Zrxinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Zrxinr) == false) {
            return false;
        }
        Zrxinr rhs = ((Zrxinr) other);

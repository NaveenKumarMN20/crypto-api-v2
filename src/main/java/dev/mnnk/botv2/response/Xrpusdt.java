...
public class Xrpusdt {
    ...
    public Xrpusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Xrpusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Xrpusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Xrpusdt) == false) {
            return false;
        }
        Xrpusdt rhs = ((Xrpusdt) other);

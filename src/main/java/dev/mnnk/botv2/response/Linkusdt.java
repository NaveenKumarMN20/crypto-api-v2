...
public class Linkusdt {
    ...
    public Linkusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Linkusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Linkusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Linkusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Linkusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Linkusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Linkusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Linkusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Linkusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Linkusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Linkusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Linkusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Linkusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Linkusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Linkusdt) == false) {
            return false;
        }
        Linkusdt rhs = ((Linkusdt) other);

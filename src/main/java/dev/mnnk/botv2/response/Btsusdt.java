...
public class Btsusdt {
    ...
    public Btsusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Btsusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Btsusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Btsusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Btsusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Btsusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Btsusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Btsusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Btsusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Btsusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Btsusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Btsusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Btsusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Btsusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Btsusdt) == false) {
            return false;
        }
        Btsusdt rhs = ((Btsusdt) other);

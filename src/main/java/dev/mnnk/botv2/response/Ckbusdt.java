...
public class Ckbusdt {
    ...
    public Ckbusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ckbusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ckbusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ckbusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ckbusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ckbusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ckbusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Ckbusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ckbusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ckbusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ckbusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ckbusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ckbusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ckbusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ckbusdt) == false) {
            return false;
        }
        Ckbusdt rhs = ((Ckbusdt) other);

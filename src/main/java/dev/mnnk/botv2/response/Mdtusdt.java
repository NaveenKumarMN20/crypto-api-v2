...
public class Mdtusdt {
    ...
    public Mdtusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Mdtusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Mdtusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Mdtusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Mdtusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Mdtusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Mdtusdt withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Mdtusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Mdtusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Mdtusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Mdtusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Mdtusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Mdtusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Mdtusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Mdtusdt) == false) {
            return false;
        }
        Mdtusdt rhs = ((Mdtusdt) other);

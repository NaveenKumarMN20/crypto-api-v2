...
public class Xvginr {
    ...
    public Xvginr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Xvginr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Xvginr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Xvginr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Xvginr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Xvginr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Xvginr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Xvginr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Xvginr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Xvginr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Xvginr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Xvginr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Xvginr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Xvginr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Xvginr) == false) {
            return false;
        }
        Xvginr rhs = ((Xvginr) other);

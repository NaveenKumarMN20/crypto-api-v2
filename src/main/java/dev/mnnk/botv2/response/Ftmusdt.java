...
public class Ftmusdt {
    ...
    public Ftmusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ftmusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ftmusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ftmusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ftmusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ftmusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ftmusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Ftmusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ftmusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ftmusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ftmusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ftmusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ftmusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ftmusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ftmusdt) == false) {
            return false;
        }
        Ftmusdt rhs = ((Ftmusdt) other);

...
public class Uniinr {
    ...
    public Uniinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Uniinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Uniinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Uniinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Uniinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Uniinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Uniinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Uniinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Uniinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Uniinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Uniinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Uniinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Uniinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Uniinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Uniinr) == false) {
            return false;
        }
        Uniinr rhs = ((Uniinr) other);

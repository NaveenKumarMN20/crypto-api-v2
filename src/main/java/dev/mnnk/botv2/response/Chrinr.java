...
public class Chrinr {
    ...
    public Chrinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Chrinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Chrinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Chrinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Chrinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Chrinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Chrinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Chrinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Chrinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Chrinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Chrinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Chrinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Chrinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Chrinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Chrinr) == false) {
            return false;
        }
        Chrinr rhs = ((Chrinr) other);

...
public class Chrusdt {
    ...
    public Chrusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Chrusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Chrusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Chrusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Chrusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Chrusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Chrusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Chrusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Chrusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Chrusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Chrusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Chrusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Chrusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Chrusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Chrusdt) == false) {
            return false;
        }
        Chrusdt rhs = ((Chrusdt) other);

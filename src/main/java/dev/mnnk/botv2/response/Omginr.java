...
public class Omginr {
    ...
    public Omginr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Omginr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Omginr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Omginr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Omginr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Omginr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Omginr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Omginr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Omginr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Omginr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Omginr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Omginr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Omginr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Omginr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Omginr) == false) {
            return false;
        }
        Omginr rhs = ((Omginr) other);

...
public class Ethwrx {
    ...
    public Ethwrx withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ethwrx withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ethwrx withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ethwrx withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ethwrx withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ethwrx withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ethwrx withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Ethwrx withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ethwrx withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ethwrx withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ethwrx withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ethwrx withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ethwrx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ethwrx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ethwrx) == false) {
            return false;
        }
        Ethwrx rhs = ((Ethwrx) other);

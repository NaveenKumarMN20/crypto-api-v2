...
public class Crvinr {
    ...
    public Crvinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Crvinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Crvinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Crvinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Crvinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Crvinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Crvinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Crvinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Crvinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Crvinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Crvinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Crvinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Crvinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Crvinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Crvinr) == false) {
            return false;
        }
        Crvinr rhs = ((Crvinr) other);

...
public class Gxsusdt {
    ...
    public Gxsusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Gxsusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Gxsusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Gxsusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Gxsusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Gxsusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Gxsusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Gxsusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Gxsusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Gxsusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Gxsusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Gxsusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Gxsusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Gxsusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Gxsusdt) == false) {
            return false;
        }
        Gxsusdt rhs = ((Gxsusdt) other);

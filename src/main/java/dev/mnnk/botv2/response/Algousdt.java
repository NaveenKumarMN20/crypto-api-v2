...
public class Algousdt {
    ...
    public Algousdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Algousdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Algousdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Algousdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Algousdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Algousdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Algousdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Algousdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Algousdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Algousdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Algousdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Algousdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Algousdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Algousdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Algousdt) == false) {
            return false;
        }
        Algousdt rhs = ((Algousdt) other);

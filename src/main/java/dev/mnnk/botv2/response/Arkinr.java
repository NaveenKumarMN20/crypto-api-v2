...
public class Arkinr {
    ...
    public Arkinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Arkinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Arkinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Arkinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Arkinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Arkinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Arkinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Arkinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Arkinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Arkinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Arkinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Arkinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Arkinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Arkinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Arkinr) == false) {
            return false;
        }
        Arkinr rhs = ((Arkinr) other);

...
public class Bnbusdt {
    ...
    public Bnbusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Bnbusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Bnbusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Bnbusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Bnbusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Bnbusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Bnbusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Bnbusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Bnbusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Bnbusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Bnbusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Bnbusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Bnbusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Bnbusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bnbusdt) == false) {
            return false;
        }
        Bnbusdt rhs = ((Bnbusdt) other);

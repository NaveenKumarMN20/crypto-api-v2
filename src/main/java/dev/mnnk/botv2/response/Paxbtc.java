...
public class Paxbtc {
    ...
    public Paxbtc withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Paxbtc withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Paxbtc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Paxbtc) == false) {
            return false;
        }
        Paxbtc rhs = ((Paxbtc) other);

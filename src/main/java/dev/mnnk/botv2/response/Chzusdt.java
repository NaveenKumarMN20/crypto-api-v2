...
public class Chzusdt {
    ...
    public Chzusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Chzusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Chzusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Chzusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Chzusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Chzusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Chzusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Chzusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Chzusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Chzusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Chzusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Chzusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Chzusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Chzusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Chzusdt) == false) {
            return false;
        }
        Chzusdt rhs = ((Chzusdt) other);

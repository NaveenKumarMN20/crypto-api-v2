...
public class Yfiinr {
    ...
    public Yfiinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Yfiinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Yfiinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Yfiinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Yfiinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Yfiinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Yfiinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Yfiinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Yfiinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Yfiinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Yfiinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Yfiinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Yfiinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Yfiinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Yfiinr) == false) {
            return false;
        }
        Yfiinr rhs = ((Yfiinr) other);

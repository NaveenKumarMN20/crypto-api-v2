...
public class Maticwrx {
    ...
    public Maticwrx withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Maticwrx withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Maticwrx withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Maticwrx withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Maticwrx withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Maticwrx withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Maticwrx withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Maticwrx withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Maticwrx withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Maticwrx withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Maticwrx withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Maticwrx withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Maticwrx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Maticwrx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Maticwrx) == false) {
            return false;
        }
        Maticwrx rhs = ((Maticwrx) other);

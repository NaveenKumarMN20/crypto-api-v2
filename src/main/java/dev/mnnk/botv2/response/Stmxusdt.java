...
public class Stmxusdt {
    ...
    public Stmxusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Stmxusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Stmxusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Stmxusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Stmxusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Stmxusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Stmxusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Stmxusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Stmxusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Stmxusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Stmxusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Stmxusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Stmxusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Stmxusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Stmxusdt) == false) {
            return false;
        }
        Stmxusdt rhs = ((Stmxusdt) other);

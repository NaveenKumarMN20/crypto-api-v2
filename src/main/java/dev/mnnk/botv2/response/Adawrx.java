...
public class Adawrx {
    ...
    public Adawrx withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Adawrx withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Adawrx withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Adawrx withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Adawrx withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Adawrx withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Adawrx withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Adawrx withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Adawrx withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Adawrx withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Adawrx withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Adawrx withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Adawrx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Adawrx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Adawrx) == false) {
            return false;
        }
        Adawrx rhs = ((Adawrx) other);

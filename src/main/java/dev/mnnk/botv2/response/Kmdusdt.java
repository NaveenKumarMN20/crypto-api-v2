...
public class Kmdusdt {
    ...
    public Kmdusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Kmdusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Kmdusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Kmdusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Kmdusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Kmdusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Kmdusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Kmdusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Kmdusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Kmdusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Kmdusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Kmdusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Kmdusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Kmdusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Kmdusdt) == false) {
            return false;
        }
        Kmdusdt rhs = ((Kmdusdt) other);

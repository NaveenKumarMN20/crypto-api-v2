...
public class Avaxinr {
    ...
    public Avaxinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Avaxinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Avaxinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Avaxinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Avaxinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Avaxinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Avaxinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Avaxinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Avaxinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Avaxinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Avaxinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Avaxinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Avaxinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Avaxinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Avaxinr) == false) {
            return false;
        }
        Avaxinr rhs = ((Avaxinr) other);

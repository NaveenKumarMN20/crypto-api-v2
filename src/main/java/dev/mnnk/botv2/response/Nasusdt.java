...
public class Nasusdt {
    ...
    public Nasusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Nasusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Nasusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Nasusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Nasusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Nasusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Nasusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Nasusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Nasusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Nasusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Nasusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Nasusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Nasusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Nasusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nasusdt) == false) {
            return false;
        }
        Nasusdt rhs = ((Nasusdt) other);

...
public class Solusdt {
    ...
    public Solusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Solusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Solusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Solusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Solusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Solusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Solusdt withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Solusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Solusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Solusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Solusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Solusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Solusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Solusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Solusdt) == false) {
            return false;
        }
        Solusdt rhs = ((Solusdt) other);

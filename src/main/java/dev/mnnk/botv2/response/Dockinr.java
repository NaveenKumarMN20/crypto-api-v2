...
public class Dockinr {
    ...
    public Dockinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Dockinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Dockinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Dockinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Dockinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Dockinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Dockinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Dockinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Dockinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Dockinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Dockinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Dockinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Dockinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Dockinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dockinr) == false) {
            return false;
        }
        Dockinr rhs = ((Dockinr) other);

...
public class Wrxinr {
    ...
    public Wrxinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Wrxinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Wrxinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Wrxinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Wrxinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Wrxinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Wrxinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Wrxinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Wrxinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Wrxinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Wrxinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Wrxinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Wrxinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Wrxinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Wrxinr) == false) {
            return false;
        }
        Wrxinr rhs = ((Wrxinr) other);

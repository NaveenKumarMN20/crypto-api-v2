...
public class Wrxusdt {
    ...
    public Wrxusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Wrxusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Wrxusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Wrxusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Wrxusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Wrxusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Wrxusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Wrxusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Wrxusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Wrxusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Wrxusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Wrxusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Wrxusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Wrxusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Wrxusdt) == false) {
            return false;
        }
        Wrxusdt rhs = ((Wrxusdt) other);

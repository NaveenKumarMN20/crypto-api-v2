...
public class Cosusdt {
    ...
    public Cosusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Cosusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Cosusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Cosusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Cosusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Cosusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Cosusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Cosusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Cosusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Cosusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Cosusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Cosusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Cosusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Cosusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cosusdt) == false) {
            return false;
        }
        Cosusdt rhs = ((Cosusdt) other);

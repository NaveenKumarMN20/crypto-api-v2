...
public class Injusdt {
    ...
    public Injusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Injusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Injusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Injusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Injusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Injusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Injusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Injusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Injusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Injusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Injusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Injusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Injusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Injusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Injusdt) == false) {
            return false;
        }
        Injusdt rhs = ((Injusdt) other);

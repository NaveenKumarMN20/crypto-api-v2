...
public class Straxusdt {
    ...
    public Straxusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Straxusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Straxusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Straxusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Straxusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Straxusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Straxusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Straxusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Straxusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Straxusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Straxusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Straxusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Straxusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Straxusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Straxusdt) == false) {
            return false;
        }
        Straxusdt rhs = ((Straxusdt) other);

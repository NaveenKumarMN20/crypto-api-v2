...
public class Ctsiusdt {
    ...
    public Ctsiusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ctsiusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ctsiusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ctsiusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ctsiusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ctsiusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ctsiusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Ctsiusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ctsiusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ctsiusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ctsiusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ctsiusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ctsiusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ctsiusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ctsiusdt) == false) {
            return false;
        }
        Ctsiusdt rhs = ((Ctsiusdt) other);

...
public class Bzrxinr {
    ...
    public Bzrxinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Bzrxinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Bzrxinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Bzrxinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Bzrxinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Bzrxinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Bzrxinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Bzrxinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Bzrxinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Bzrxinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Bzrxinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Bzrxinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Bzrxinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Bzrxinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bzrxinr) == false) {
            return false;
        }
        Bzrxinr rhs = ((Bzrxinr) other);

...
public class Compusdt {
    ...
    public Compusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Compusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Compusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Compusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Compusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Compusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Compusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Compusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Compusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Compusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Compusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Compusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Compusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Compusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Compusdt) == false) {
            return false;
        }
        Compusdt rhs = ((Compusdt) other);

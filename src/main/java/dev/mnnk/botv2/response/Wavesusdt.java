...
public class Wavesusdt {
    ...
    public Wavesusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Wavesusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Wavesusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Wavesusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Wavesusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Wavesusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Wavesusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Wavesusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Wavesusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Wavesusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Wavesusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Wavesusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Wavesusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Wavesusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Wavesusdt) == false) {
            return false;
        }
        Wavesusdt rhs = ((Wavesusdt) other);

...
public class Dogeusdt {
    ...
    public Dogeusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Dogeusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Dogeusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Dogeusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Dogeusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Dogeusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Dogeusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Dogeusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Dogeusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Dogeusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Dogeusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Dogeusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Dogeusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Dogeusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dogeusdt) == false) {
            return false;
        }
        Dogeusdt rhs = ((Dogeusdt) other);

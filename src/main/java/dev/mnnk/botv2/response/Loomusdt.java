...
public class Loomusdt {
    ...
    public Loomusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Loomusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Loomusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Loomusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Loomusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Loomusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Loomusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Loomusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Loomusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Loomusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Loomusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Loomusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Loomusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Loomusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Loomusdt) == false) {
            return false;
        }
        Loomusdt rhs = ((Loomusdt) other);

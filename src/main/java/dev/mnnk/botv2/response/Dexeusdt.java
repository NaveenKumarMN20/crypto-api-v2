...
public class Dexeusdt {
    ...
    public Dexeusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Dexeusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Dexeusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Dexeusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Dexeusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Dexeusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Dexeusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Dexeusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Dexeusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Dexeusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Dexeusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Dexeusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Dexeusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Dexeusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dexeusdt) == false) {
            return false;
        }
        Dexeusdt rhs = ((Dexeusdt) other);

...
public class Busdusdt {
    ...
    public Busdusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Busdusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Busdusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Busdusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Busdusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Busdusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Busdusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Busdusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Busdusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Busdusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Busdusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Busdusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Busdusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Busdusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Busdusdt) == false) {
            return false;
        }
        Busdusdt rhs = ((Busdusdt) other);

...
public class Xvgusdt {
    ...
    public Xvgusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Xvgusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Xvgusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Xvgusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Xvgusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Xvgusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Xvgusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Xvgusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Xvgusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Xvgusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Xvgusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Xvgusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Xvgusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Xvgusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Xvgusdt) == false) {
            return false;
        }
        Xvgusdt rhs = ((Xvgusdt) other);

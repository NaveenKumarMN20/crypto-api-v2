...
public class Duskusdt {
    ...
    public Duskusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Duskusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Duskusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Duskusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Duskusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Duskusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Duskusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Duskusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Duskusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Duskusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Duskusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Duskusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Duskusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Duskusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Duskusdt) == false) {
            return false;
        }
        Duskusdt rhs = ((Duskusdt) other);

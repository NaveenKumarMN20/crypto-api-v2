...
public class Batwrx {
    ...
    public Batwrx withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Batwrx withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Batwrx withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Batwrx withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Batwrx withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Batwrx withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Batwrx withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Batwrx withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Batwrx withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Batwrx withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Batwrx withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Batwrx withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Batwrx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Batwrx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Batwrx) == false) {
            return false;
        }
        Batwrx rhs = ((Batwrx) other);

...
public class Cakeinr {
    ...
    public Cakeinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Cakeinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Cakeinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Cakeinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Cakeinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Cakeinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Cakeinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Cakeinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Cakeinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Cakeinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Cakeinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Cakeinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Cakeinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Cakeinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cakeinr) == false) {
            return false;
        }
        Cakeinr rhs = ((Cakeinr) other);

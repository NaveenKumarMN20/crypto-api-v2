...
public class Mtlusdt {
    ...
    public Mtlusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Mtlusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Mtlusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Mtlusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Mtlusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Mtlusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Mtlusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Mtlusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Mtlusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Mtlusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Mtlusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Mtlusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Mtlusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Mtlusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Mtlusdt) == false) {
            return false;
        }
        Mtlusdt rhs = ((Mtlusdt) other);

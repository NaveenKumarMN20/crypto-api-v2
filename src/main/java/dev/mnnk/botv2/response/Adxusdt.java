...
public class Adxusdt {
    ...
    public Adxusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Adxusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Adxusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Adxusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Adxusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Adxusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Adxusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Adxusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Adxusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Adxusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Adxusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Adxusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Adxusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Adxusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Adxusdt) == false) {
            return false;
        }
        Adxusdt rhs = ((Adxusdt) other);

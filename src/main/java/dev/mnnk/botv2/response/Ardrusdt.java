...
public class Ardrusdt {
    ...
    public Ardrusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ardrusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ardrusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ardrusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ardrusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ardrusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ardrusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Ardrusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ardrusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ardrusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ardrusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ardrusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ardrusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ardrusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ardrusdt) == false) {
            return false;
        }
        Ardrusdt rhs = ((Ardrusdt) other);

...
public class Swrvusdt {
    ...
    public Swrvusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Swrvusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Swrvusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Swrvusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Swrvusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Swrvusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Swrvusdt withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Swrvusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Swrvusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Swrvusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Swrvusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Swrvusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Swrvusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Swrvusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Swrvusdt) == false) {
            return false;
        }
        Swrvusdt rhs = ((Swrvusdt) other);

...
public class Repusdt {
    ...
    public Repusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Repusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Repusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Repusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Repusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Repusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Repusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Repusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Repusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Repusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Repusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Repusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Repusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Repusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Repusdt) == false) {
            return false;
        }
        Repusdt rhs = ((Repusdt) other);

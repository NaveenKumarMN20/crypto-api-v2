...
public class Cakeusdt {
    ...
    public Cakeusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Cakeusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Cakeusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Cakeusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Cakeusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Cakeusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Cakeusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Cakeusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Cakeusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Cakeusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Cakeusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Cakeusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Cakeusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Cakeusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cakeusdt) == false) {
            return false;
        }
        Cakeusdt rhs = ((Cakeusdt) other);

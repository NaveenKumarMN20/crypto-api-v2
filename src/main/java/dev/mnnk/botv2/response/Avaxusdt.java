...
public class Avaxusdt {
    ...
    public Avaxusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Avaxusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Avaxusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Avaxusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Avaxusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Avaxusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Avaxusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Avaxusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Avaxusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Avaxusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Avaxusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Avaxusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Avaxusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Avaxusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Avaxusdt) == false) {
            return false;
        }
        Avaxusdt rhs = ((Avaxusdt) other);

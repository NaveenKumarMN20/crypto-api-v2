...
public class Bnbwrx {
    ...
    public Bnbwrx withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Bnbwrx withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Bnbwrx withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Bnbwrx withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Bnbwrx withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Bnbwrx withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Bnbwrx withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Bnbwrx withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Bnbwrx withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Bnbwrx withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Bnbwrx withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Bnbwrx withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Bnbwrx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Bnbwrx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bnbwrx) == false) {
            return false;
        }
        Bnbwrx rhs = ((Bnbwrx) other);

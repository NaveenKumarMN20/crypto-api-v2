...
public class Blzusdt {
    ...
    public Blzusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Blzusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Blzusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Blzusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Blzusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Blzusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Blzusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Blzusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Blzusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Blzusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Blzusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Blzusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Blzusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Blzusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Blzusdt) == false) {
            return false;
        }
        Blzusdt rhs = ((Blzusdt) other);

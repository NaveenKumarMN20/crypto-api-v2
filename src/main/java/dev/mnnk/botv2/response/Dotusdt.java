...
public class Dotusdt {
    ...
    public Dotusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Dotusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Dotusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Dotusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Dotusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Dotusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Dotusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Dotusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Dotusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Dotusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Dotusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Dotusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Dotusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Dotusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dotusdt) == false) {
            return false;
        }
        Dotusdt rhs = ((Dotusdt) other);

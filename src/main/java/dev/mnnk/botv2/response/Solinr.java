...
public class Solinr {
    ...
    public Solinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Solinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Solinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Solinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Solinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Solinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Solinr withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Solinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Solinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Solinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Solinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Solinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Solinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Solinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Solinr) == false) {
            return false;
        }
        Solinr rhs = ((Solinr) other);

...
public class Arkusdt {
    ...
    public Arkusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Arkusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Arkusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Arkusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Arkusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Arkusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Arkusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Arkusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Arkusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Arkusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Arkusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Arkusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Arkusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Arkusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Arkusdt) == false) {
            return false;
        }
        Arkusdt rhs = ((Arkusdt) other);

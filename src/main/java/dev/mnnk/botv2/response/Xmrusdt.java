...
public class Xmrusdt {
    ...
    public Xmrusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Xmrusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Xmrusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Xmrusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Xmrusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Xmrusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Xmrusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Xmrusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Xmrusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Xmrusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Xmrusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Xmrusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Xmrusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Xmrusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Xmrusdt) == false) {
            return false;
        }
        Xmrusdt rhs = ((Xmrusdt) other);

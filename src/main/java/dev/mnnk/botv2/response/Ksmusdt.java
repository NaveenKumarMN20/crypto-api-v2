...
public class Ksmusdt {
    ...
    public Ksmusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ksmusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ksmusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ksmusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ksmusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ksmusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ksmusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Ksmusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ksmusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ksmusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ksmusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ksmusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ksmusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ksmusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ksmusdt) == false) {
            return false;
        }
        Ksmusdt rhs = ((Ksmusdt) other);

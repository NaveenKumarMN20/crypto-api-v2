...
public class Xemusdt {
    ...
    public Xemusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Xemusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Xemusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Xemusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Xemusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Xemusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Xemusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Xemusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Xemusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Xemusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Xemusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Xemusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Xemusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Xemusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Xemusdt) == false) {
            return false;
        }
        Xemusdt rhs = ((Xemusdt) other);

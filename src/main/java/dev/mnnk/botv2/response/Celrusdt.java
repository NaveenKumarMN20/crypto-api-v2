...
public class Celrusdt {
    ...
    public Celrusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Celrusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Celrusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Celrusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Celrusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Celrusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Celrusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Celrusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Celrusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Celrusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Celrusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Celrusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Celrusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Celrusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Celrusdt) == false) {
            return false;
        }
        Celrusdt rhs = ((Celrusdt) other);

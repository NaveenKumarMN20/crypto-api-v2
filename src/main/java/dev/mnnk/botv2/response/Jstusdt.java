...
public class Jstusdt {
    ...
    public Jstusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Jstusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Jstusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Jstusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Jstusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Jstusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Jstusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Jstusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Jstusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Jstusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Jstusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Jstusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Jstusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Jstusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Jstusdt) == false) {
            return false;
        }
        Jstusdt rhs = ((Jstusdt) other);

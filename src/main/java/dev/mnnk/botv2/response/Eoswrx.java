...
public class Eoswrx {
    ...
    public Eoswrx withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Eoswrx withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Eoswrx withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Eoswrx withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Eoswrx withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Eoswrx withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Eoswrx withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Eoswrx withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Eoswrx withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Eoswrx withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Eoswrx withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Eoswrx withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Eoswrx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Eoswrx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Eoswrx) == false) {
            return false;
        }
        Eoswrx rhs = ((Eoswrx) other);

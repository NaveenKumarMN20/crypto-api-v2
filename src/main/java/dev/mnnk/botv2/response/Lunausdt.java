...
public class Lunausdt {
    ...
    public Lunausdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Lunausdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Lunausdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Lunausdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Lunausdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Lunausdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Lunausdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Lunausdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Lunausdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Lunausdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Lunausdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Lunausdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Lunausdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Lunausdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Lunausdt) == false) {
            return false;
        }
        Lunausdt rhs = ((Lunausdt) other);

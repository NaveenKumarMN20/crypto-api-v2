...
public class Hbarusdt {
    ...
    public Hbarusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Hbarusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Hbarusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Hbarusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Hbarusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Hbarusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Hbarusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Hbarusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Hbarusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Hbarusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Hbarusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Hbarusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Hbarusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Hbarusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Hbarusdt) == false) {
            return false;
        }
        Hbarusdt rhs = ((Hbarusdt) other);

...
public class Nanoinr {
    ...
    public Nanoinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Nanoinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Nanoinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Nanoinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Nanoinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Nanoinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Nanoinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Nanoinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Nanoinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Nanoinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Nanoinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Nanoinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Nanoinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Nanoinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nanoinr) == false) {
            return false;
        }
        Nanoinr rhs = ((Nanoinr) other);

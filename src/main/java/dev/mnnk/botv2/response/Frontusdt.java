...
public class Frontusdt {
    ...
    public Frontusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Frontusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Frontusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Frontusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Frontusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Frontusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Frontusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Frontusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Frontusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Frontusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Frontusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Frontusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Frontusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Frontusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Frontusdt) == false) {
            return false;
        }
        Frontusdt rhs = ((Frontusdt) other);

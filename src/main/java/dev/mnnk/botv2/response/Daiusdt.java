...
public class Daiusdt {
    ...
    public Daiusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Daiusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Daiusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Daiusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Daiusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Daiusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Daiusdt withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Daiusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Daiusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Daiusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Daiusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Daiusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Daiusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Daiusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Daiusdt) == false) {
            return false;
        }
        Daiusdt rhs = ((Daiusdt) other);

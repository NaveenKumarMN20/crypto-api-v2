...
public class Fttbtc {
    ...
    public Fttbtc withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Fttbtc withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Fttbtc withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Fttbtc withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Fttbtc withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Fttbtc withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Fttbtc withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Fttbtc withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Fttbtc withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Fttbtc withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Fttbtc withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Fttbtc withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Fttbtc withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Fttbtc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fttbtc) == false) {
            return false;
        }
        Fttbtc rhs = ((Fttbtc) other);

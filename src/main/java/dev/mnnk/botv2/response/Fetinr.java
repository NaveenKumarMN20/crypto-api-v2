...
public class Fetinr {
    ...
    public Fetinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Fetinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Fetinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Fetinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Fetinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Fetinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Fetinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Fetinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Fetinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Fetinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Fetinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Fetinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Fetinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Fetinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fetinr) == false) {
            return false;
        }
        Fetinr rhs = ((Fetinr) other);

...
public class Balusdt {
    ...
    public Balusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Balusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Balusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Balusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Balusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Balusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Balusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Balusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Balusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Balusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Balusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Balusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Balusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Balusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Balusdt) == false) {
            return false;
        }
        Balusdt rhs = ((Balusdt) other);

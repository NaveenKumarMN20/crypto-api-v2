...
public class Cvcinr {
    ...
    public Cvcinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Cvcinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Cvcinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Cvcinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Cvcinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Cvcinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Cvcinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Cvcinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Cvcinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Cvcinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Cvcinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Cvcinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Cvcinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Cvcinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cvcinr) == false) {
            return false;
        }
        Cvcinr rhs = ((Cvcinr) other);

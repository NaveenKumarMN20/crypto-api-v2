...
public class Dogeinr {
    ...
    public Dogeinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Dogeinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Dogeinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Dogeinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Dogeinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Dogeinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Dogeinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Dogeinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Dogeinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Dogeinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Dogeinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Dogeinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Dogeinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Dogeinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dogeinr) == false) {
            return false;
        }
        Dogeinr rhs = ((Dogeinr) other);

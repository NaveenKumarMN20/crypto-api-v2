...
public class Dashinr {
    ...
    public Dashinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Dashinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Dashinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Dashinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Dashinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Dashinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Dashinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Dashinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Dashinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Dashinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Dashinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Dashinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Dashinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Dashinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dashinr) == false) {
            return false;
        }
        Dashinr rhs = ((Dashinr) other);

...
public class Tkousdt {
    ...
    public Tkousdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Tkousdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Tkousdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Tkousdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Tkousdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Tkousdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Tkousdt withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Tkousdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Tkousdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Tkousdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Tkousdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Tkousdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Tkousdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Tkousdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tkousdt) == false) {
            return false;
        }
        Tkousdt rhs = ((Tkousdt) other);

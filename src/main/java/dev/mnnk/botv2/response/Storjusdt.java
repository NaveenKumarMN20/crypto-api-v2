...
public class Storjusdt {
    ...
    public Storjusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Storjusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Storjusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Storjusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Storjusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Storjusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Storjusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Storjusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Storjusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Storjusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Storjusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Storjusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Storjusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Storjusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Storjusdt) == false) {
            return false;
        }
        Storjusdt rhs = ((Storjusdt) other);

...
public class Stxusdt {
    ...
    public Stxusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Stxusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Stxusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Stxusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Stxusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Stxusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Stxusdt withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Stxusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Stxusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Stxusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Stxusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Stxusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Stxusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Stxusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Stxusdt) == false) {
            return false;
        }
        Stxusdt rhs = ((Stxusdt) other);

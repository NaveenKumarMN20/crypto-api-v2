...
public class Paxgusdt {
    ...
    public Paxgusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Paxgusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Paxgusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Paxgusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Paxgusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Paxgusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Paxgusdt withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Paxgusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Paxgusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Paxgusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Paxgusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Paxgusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Paxgusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Paxgusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Paxgusdt) == false) {
            return false;
        }
        Paxgusdt rhs = ((Paxgusdt) other);

...
public class Etcusdt {
    ...
    public Etcusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Etcusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Etcusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Etcusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Etcusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Etcusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Etcusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Etcusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Etcusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Etcusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Etcusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Etcusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Etcusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Etcusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Etcusdt) == false) {
            return false;
        }
        Etcusdt rhs = ((Etcusdt) other);

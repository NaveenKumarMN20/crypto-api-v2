...
public class Aionusdt {
    ...
    public Aionusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Aionusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Aionusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Aionusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Aionusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Aionusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Aionusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Aionusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Aionusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Aionusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Aionusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Aionusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Aionusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Aionusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Aionusdt) == false) {
            return false;
        }
        Aionusdt rhs = ((Aionusdt) other);

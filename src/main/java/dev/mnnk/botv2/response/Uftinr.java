...
public class Uftinr {
    ...
    public Uftinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Uftinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Uftinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Uftinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Uftinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Uftinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Uftinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Uftinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Uftinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Uftinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Uftinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Uftinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Uftinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Uftinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Uftinr) == false) {
            return false;
        }
        Uftinr rhs = ((Uftinr) other);

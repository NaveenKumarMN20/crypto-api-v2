...
public class _1inchusdt {
    ...
    public _1inchusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public _1inchusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public _1inchusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public _1inchusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public _1inchusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public _1inchusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public _1inchusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public _1inchusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public _1inchusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public _1inchusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public _1inchusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public _1inchusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public _1inchusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(_1inchusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _1inchusdt) == false) {
            return false;
        }
        _1inchusdt rhs = ((_1inchusdt) other);

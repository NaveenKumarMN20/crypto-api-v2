...
public class Gtousdt {
    ...
    public Gtousdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Gtousdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Gtousdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Gtousdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Gtousdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Gtousdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Gtousdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Gtousdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Gtousdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Gtousdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Gtousdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Gtousdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Gtousdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Gtousdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Gtousdt) == false) {
            return false;
        }
        Gtousdt rhs = ((Gtousdt) other);

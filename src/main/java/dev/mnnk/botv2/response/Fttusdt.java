...
public class Fttusdt {
    ...
    public Fttusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Fttusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Fttusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Fttusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Fttusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Fttusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Fttusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Fttusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Fttusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Fttusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Fttusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Fttusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Fttusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Fttusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fttusdt) == false) {
            return false;
        }
        Fttusdt rhs = ((Fttusdt) other);

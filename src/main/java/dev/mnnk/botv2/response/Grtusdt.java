...
public class Grtusdt {
    ...
    public Grtusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Grtusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Grtusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Grtusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Grtusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Grtusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Grtusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Grtusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Grtusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Grtusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Grtusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Grtusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Grtusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Grtusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Grtusdt) == false) {
            return false;
        }
        Grtusdt rhs = ((Grtusdt) other);

...
public class Neousdt {
    ...
    public Neousdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Neousdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Neousdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Neousdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Neousdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Neousdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Neousdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Neousdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Neousdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Neousdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Neousdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Neousdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Neousdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Neousdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Neousdt) == false) {
            return false;
        }
        Neousdt rhs = ((Neousdt) other);

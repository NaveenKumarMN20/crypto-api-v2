...
public class Scusdt {
    ...
    public Scusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Scusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Scusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Scusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Scusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Scusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Scusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Scusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Scusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Scusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Scusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Scusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Scusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scusdt) == false) {
            return false;
        }
        Scusdt rhs = ((Scusdt) other);

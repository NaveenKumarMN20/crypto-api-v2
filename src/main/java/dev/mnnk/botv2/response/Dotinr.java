...
public class Dotinr {
    ...
    public Dotinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Dotinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Dotinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Dotinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Dotinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Dotinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Dotinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Dotinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Dotinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Dotinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Dotinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Dotinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Dotinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Dotinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dotinr) == false) {
            return false;
        }
        Dotinr rhs = ((Dotinr) other);

...
public class Rvnusdt {
    ...
    public Rvnusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Rvnusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Rvnusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Rvnusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Rvnusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Rvnusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Rvnusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Rvnusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Rvnusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Rvnusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Rvnusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Rvnusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Rvnusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Rvnusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Rvnusdt) == false) {
            return false;
        }
        Rvnusdt rhs = ((Rvnusdt) other);

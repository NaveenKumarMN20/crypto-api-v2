...
public class Xmrbtc {
    ...
    public Xmrbtc withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Xmrbtc withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Xmrbtc withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Xmrbtc withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Xmrbtc withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Xmrbtc withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Xmrbtc withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Xmrbtc withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Xmrbtc withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Xmrbtc withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Xmrbtc withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Xmrbtc withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Xmrbtc withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Xmrbtc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Xmrbtc) == false) {
            return false;
        }
        Xmrbtc rhs = ((Xmrbtc) other);

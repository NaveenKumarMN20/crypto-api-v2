...
public class Aaveusdt {
    ...
    public Aaveusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Aaveusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Aaveusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Aaveusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Aaveusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Aaveusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Aaveusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Aaveusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Aaveusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Aaveusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Aaveusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Aaveusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Aaveusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Aaveusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Aaveusdt) == false) {
            return false;
        }
        Aaveusdt rhs = ((Aaveusdt) other);

...
public class Glmbtc {
    ...
    public Glmbtc withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Glmbtc withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Glmbtc withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Glmbtc withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Glmbtc withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Glmbtc withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Glmbtc withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Glmbtc withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Glmbtc withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Glmbtc withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Glmbtc withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Glmbtc withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Glmbtc withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Glmbtc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Glmbtc) == false) {
            return false;
        }
        Glmbtc rhs = ((Glmbtc) other);

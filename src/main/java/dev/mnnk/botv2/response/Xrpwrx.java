...
public class Xrpwrx {
    ...
    public Xrpwrx withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Xrpwrx withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Xrpwrx withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Xrpwrx withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Xrpwrx withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Xrpwrx withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Xrpwrx withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Xrpwrx withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Xrpwrx withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Xrpwrx withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Xrpwrx withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Xrpwrx withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Xrpwrx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Xrpwrx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Xrpwrx) == false) {
            return false;
        }
        Xrpwrx rhs = ((Xrpwrx) other);

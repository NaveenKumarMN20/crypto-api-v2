...
public class Atominr {
    ...
    public Atominr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Atominr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Atominr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Atominr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Atominr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Atominr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Atominr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Atominr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Atominr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Atominr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Atominr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Atominr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Atominr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Atominr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Atominr) == false) {
            return false;
        }
        Atominr rhs = ((Atominr) other);

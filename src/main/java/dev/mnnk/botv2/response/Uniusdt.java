...
public class Uniusdt {
    ...
    public Uniusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Uniusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Uniusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Uniusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Uniusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Uniusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Uniusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Uniusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Uniusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Uniusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Uniusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Uniusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Uniusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Uniusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Uniusdt) == false) {
            return false;
        }
        Uniusdt rhs = ((Uniusdt) other);

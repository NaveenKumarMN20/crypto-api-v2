...
public class Winusdt {
    ...
    public Winusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Winusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Winusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Winusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Winusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Winusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Winusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Winusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Winusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Winusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Winusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Winusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Winusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Winusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Winusdt) == false) {
            return false;
        }
        Winusdt rhs = ((Winusdt) other);

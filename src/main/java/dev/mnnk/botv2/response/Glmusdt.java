...
public class Glmusdt {
    ...
    public Glmusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Glmusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Glmusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Glmusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Glmusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Glmusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Glmusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Glmusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Glmusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Glmusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Glmusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Glmusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Glmusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Glmusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Glmusdt) == false) {
            return false;
        }
        Glmusdt rhs = ((Glmusdt) other);

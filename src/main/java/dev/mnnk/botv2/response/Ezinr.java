...
public class Ezinr {
    ...
    public Ezinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ezinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ezinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ezinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ezinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ezinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ezinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Ezinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ezinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ezinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ezinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ezinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ezinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ezinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ezinr) == false) {
            return false;
        }
        Ezinr rhs = ((Ezinr) other);

...
public class Maticinr {
    ...
    public Maticinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Maticinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Maticinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Maticinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Maticinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Maticinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Maticinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Maticinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Maticinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Maticinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Maticinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Maticinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Maticinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Maticinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Maticinr) == false) {
            return false;
        }
        Maticinr rhs = ((Maticinr) other);

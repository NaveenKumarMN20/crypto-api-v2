...
public class Dgbusdt {
    ...
    public Dgbusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Dgbusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Dgbusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Dgbusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Dgbusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Dgbusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Dgbusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Dgbusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Dgbusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Dgbusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Dgbusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Dgbusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Dgbusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Dgbusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dgbusdt) == false) {
            return false;
        }
        Dgbusdt rhs = ((Dgbusdt) other);

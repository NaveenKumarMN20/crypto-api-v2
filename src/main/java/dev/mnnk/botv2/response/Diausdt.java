...
public class Diausdt {
    ...
    public Diausdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Diausdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Diausdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Diausdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Diausdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Diausdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Diausdt withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Diausdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Diausdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Diausdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Diausdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Diausdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Diausdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Diausdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Diausdt) == false) {
            return false;
        }
        Diausdt rhs = ((Diausdt) other);

...
public class Ftminr {
    ...
    public Ftminr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ftminr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ftminr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ftminr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ftminr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ftminr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ftminr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Ftminr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ftminr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ftminr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ftminr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ftminr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ftminr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ftminr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ftminr) == false) {
            return false;
        }
        Ftminr rhs = ((Ftminr) other);

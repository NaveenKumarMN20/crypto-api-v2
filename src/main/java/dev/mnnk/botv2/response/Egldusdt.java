...
public class Egldusdt {
    ...
    public Egldusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Egldusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Egldusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Egldusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Egldusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Egldusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Egldusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Egldusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Egldusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Egldusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Egldusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Egldusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Egldusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Egldusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Egldusdt) == false) {
            return false;
        }
        Egldusdt rhs = ((Egldusdt) other);

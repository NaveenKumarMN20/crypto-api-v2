...
public class Filinr {
    ...
    public Filinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Filinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Filinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Filinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Filinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Filinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Filinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Filinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Filinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Filinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Filinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Filinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Filinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Filinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Filinr) == false) {
            return false;
        }
        Filinr rhs = ((Filinr) other);

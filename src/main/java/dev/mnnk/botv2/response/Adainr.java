...
public class Adainr {
    ...
    public Adainr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Adainr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Adainr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Adainr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Adainr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Adainr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Adainr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Adainr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Adainr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Adainr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Adainr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Adainr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Adainr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Adainr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Adainr) == false) {
            return false;
        }
        Adainr rhs = ((Adainr) other);

...
public class Ctsiinr {
    ...
    public Ctsiinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ctsiinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ctsiinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ctsiinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ctsiinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ctsiinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ctsiinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Ctsiinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ctsiinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ctsiinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ctsiinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ctsiinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ctsiinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ctsiinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ctsiinr) == false) {
            return false;
        }
        Ctsiinr rhs = ((Ctsiinr) other);

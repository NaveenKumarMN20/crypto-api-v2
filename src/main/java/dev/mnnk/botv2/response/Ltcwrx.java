...
public class Ltcwrx {
    ...
    public Ltcwrx withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ltcwrx withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ltcwrx withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ltcwrx withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ltcwrx withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ltcwrx withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ltcwrx withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Ltcwrx withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ltcwrx withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ltcwrx withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ltcwrx withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ltcwrx withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ltcwrx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ltcwrx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ltcwrx) == false) {
            return false;
        }
        Ltcwrx rhs = ((Ltcwrx) other);

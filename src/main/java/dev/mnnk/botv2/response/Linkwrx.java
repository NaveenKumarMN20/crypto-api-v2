...
public class Linkwrx {
    ...
    public Linkwrx withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Linkwrx withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Linkwrx withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Linkwrx withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Linkwrx withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Linkwrx withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Linkwrx withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Linkwrx withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Linkwrx withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Linkwrx withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Linkwrx withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Linkwrx withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Linkwrx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Linkwrx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Linkwrx) == false) {
            return false;
        }
        Linkwrx rhs = ((Linkwrx) other);

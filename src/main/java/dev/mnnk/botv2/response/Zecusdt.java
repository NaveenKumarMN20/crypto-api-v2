...
public class Zecusdt {
    ...
    public Zecusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Zecusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Zecusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Zecusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Zecusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Zecusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Zecusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Zecusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Zecusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Zecusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Zecusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Zecusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Zecusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Zecusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Zecusdt) == false) {
            return false;
        }
        Zecusdt rhs = ((Zecusdt) other);

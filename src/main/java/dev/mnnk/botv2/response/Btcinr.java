...
public class Btcinr {
    ...
    public Btcinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Btcinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Btcinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Btcinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Btcinr) == false) {
            return false;
        }
        Btcinr rhs = ((Btcinr) other);

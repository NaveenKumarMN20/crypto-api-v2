...
public class Umainr {
    ...
    public Umainr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Umainr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Umainr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Umainr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Umainr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Umainr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Umainr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Umainr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Umainr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Umainr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Umainr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Umainr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Umainr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Umainr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Umainr) == false) {
            return false;
        }
        Umainr rhs = ((Umainr) other);

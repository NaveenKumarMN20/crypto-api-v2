...
public class Nanousdt {
    ...
    public Nanousdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Nanousdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Nanousdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Nanousdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Nanousdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Nanousdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Nanousdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Nanousdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Nanousdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Nanousdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Nanousdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Nanousdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Nanousdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Nanousdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nanousdt) == false) {
            return false;
        }
        Nanousdt rhs = ((Nanousdt) other);

...
public class Lrcusdt {
    ...
    public Lrcusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Lrcusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Lrcusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Lrcusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Lrcusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Lrcusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Lrcusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Lrcusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Lrcusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Lrcusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Lrcusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Lrcusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Lrcusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Lrcusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Lrcusdt) == false) {
            return false;
        }
        Lrcusdt rhs = ((Lrcusdt) other);

...
public class Dockusdt {
    ...
    public Dockusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Dockusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Dockusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Dockusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Dockusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Dockusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Dockusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Dockusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Dockusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Dockusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Dockusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Dockusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Dockusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Dockusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dockusdt) == false) {
            return false;
        }
        Dockusdt rhs = ((Dockusdt) other);

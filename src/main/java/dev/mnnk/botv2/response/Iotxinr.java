...
public class Iotxinr {
    ...
    public Iotxinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Iotxinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Iotxinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Iotxinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Iotxinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Iotxinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Iotxinr withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Iotxinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Iotxinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Iotxinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Iotxinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Iotxinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Iotxinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Iotxinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Iotxinr) == false) {
            return false;
        }
        Iotxinr rhs = ((Iotxinr) other);

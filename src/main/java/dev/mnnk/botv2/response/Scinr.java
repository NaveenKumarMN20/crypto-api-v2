...
public class Scinr {
    ...
    public Scinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Scinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Scinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Scinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Scinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Scinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Scinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Scinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Scinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Scinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Scinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Scinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Scinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scinr) == false) {
            return false;
        }
        Scinr rhs = ((Scinr) other);

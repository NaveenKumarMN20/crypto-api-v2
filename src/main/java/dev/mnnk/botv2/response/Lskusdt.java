...
public class Lskusdt {
    ...
    public Lskusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Lskusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Lskusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Lskusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Lskusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Lskusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Lskusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Lskusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Lskusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Lskusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Lskusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Lskusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Lskusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Lskusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Lskusdt) == false) {
            return false;
        }
        Lskusdt rhs = ((Lskusdt) other);

...
public class Hiveusdt {
    ...
    public Hiveusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Hiveusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Hiveusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Hiveusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Hiveusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Hiveusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Hiveusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Hiveusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Hiveusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Hiveusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Hiveusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Hiveusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Hiveusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Hiveusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Hiveusdt) == false) {
            return false;
        }
        Hiveusdt rhs = ((Hiveusdt) other);

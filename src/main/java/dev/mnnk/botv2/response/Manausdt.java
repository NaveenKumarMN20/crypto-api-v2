...
public class Manausdt {
    ...
    public Manausdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Manausdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Manausdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Manausdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Manausdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Manausdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Manausdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Manausdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Manausdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Manausdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Manausdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Manausdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Manausdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Manausdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Manausdt) == false) {
            return false;
        }
        Manausdt rhs = ((Manausdt) other);

...
public class Hbarinr {
    ...
    public Hbarinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Hbarinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Hbarinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Hbarinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Hbarinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Hbarinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Hbarinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Hbarinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Hbarinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Hbarinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Hbarinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Hbarinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Hbarinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Hbarinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Hbarinr) == false) {
            return false;
        }
        Hbarinr rhs = ((Hbarinr) other);

...
public class Vetinr {
    ...
    public Vetinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Vetinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Vetinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Vetinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Vetinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Vetinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Vetinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Vetinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Vetinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Vetinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Vetinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Vetinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Vetinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Vetinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Vetinr) == false) {
            return false;
        }
        Vetinr rhs = ((Vetinr) other);

...
public class Enjusdt {
    ...
    public Enjusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Enjusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Enjusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Enjusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Enjusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Enjusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Enjusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Enjusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Enjusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Enjusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Enjusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Enjusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Enjusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Enjusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Enjusdt) == false) {
            return false;
        }
        Enjusdt rhs = ((Enjusdt) other);

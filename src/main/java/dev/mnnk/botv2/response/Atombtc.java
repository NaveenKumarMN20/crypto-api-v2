...
public class Atombtc {
    ...
    public Atombtc withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Atombtc withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Atombtc withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Atombtc withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Atombtc withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Atombtc withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Atombtc withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Atombtc withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Atombtc withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Atombtc withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Atombtc withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Atombtc withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Atombtc withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Atombtc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Atombtc) == false) {
            return false;
        }
        Atombtc rhs = ((Atombtc) other);

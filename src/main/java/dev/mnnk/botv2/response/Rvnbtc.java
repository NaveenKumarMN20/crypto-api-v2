...
public class Rvnbtc {
    ...
    public Rvnbtc withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Rvnbtc withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Rvnbtc withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Rvnbtc withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Rvnbtc withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Rvnbtc withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Rvnbtc withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Rvnbtc withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Rvnbtc withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Rvnbtc withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Rvnbtc withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Rvnbtc withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Rvnbtc withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Rvnbtc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Rvnbtc) == false) {
            return false;
        }
        Rvnbtc rhs = ((Rvnbtc) other);

...
public class Cotiusdt {
    ...
    public Cotiusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Cotiusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Cotiusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Cotiusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Cotiusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Cotiusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Cotiusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Cotiusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Cotiusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Cotiusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Cotiusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Cotiusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Cotiusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Cotiusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cotiusdt) == false) {
            return false;
        }
        Cotiusdt rhs = ((Cotiusdt) other);

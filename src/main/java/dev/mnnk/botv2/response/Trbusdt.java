...
public class Trbusdt {
    ...
    public Trbusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Trbusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Trbusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Trbusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Trbusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Trbusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Trbusdt withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Trbusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Trbusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Trbusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Trbusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Trbusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Trbusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Trbusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Trbusdt) == false) {
            return false;
        }
        Trbusdt rhs = ((Trbusdt) other);

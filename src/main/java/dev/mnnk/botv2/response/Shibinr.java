...
public class Shibinr {
    ...
    public Shibinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Shibinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Shibinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Shibinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Shibinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Shibinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Shibinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Shibinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Shibinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Shibinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Shibinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Shibinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Shibinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Shibinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shibinr) == false) {
            return false;
        }
        Shibinr rhs = ((Shibinr) other);

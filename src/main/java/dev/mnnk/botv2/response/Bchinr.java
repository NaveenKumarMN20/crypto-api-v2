...
public class Bchinr {
    ...
    public Bchinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Bchinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Bchinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Bchinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Bchinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Bchinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Bchinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Bchinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Bchinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Bchinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Bchinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Bchinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Bchinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Bchinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bchinr) == false) {
            return false;
        }
        Bchinr rhs = ((Bchinr) other);

...
public class Yfiwrx {
    ...
    public Yfiwrx withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Yfiwrx withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Yfiwrx withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Yfiwrx withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Yfiwrx withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Yfiwrx withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Yfiwrx withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Yfiwrx withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Yfiwrx withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Yfiwrx withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Yfiwrx withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Yfiwrx withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Yfiwrx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Yfiwrx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Yfiwrx) == false) {
            return false;
        }
        Yfiwrx rhs = ((Yfiwrx) other);

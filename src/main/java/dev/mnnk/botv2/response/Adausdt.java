...
public class Adausdt {
    ...
    public Adausdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Adausdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Adausdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Adausdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Adausdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Adausdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Adausdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Adausdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Adausdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Adausdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Adausdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Adausdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Adausdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Adausdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Adausdt) == false) {
            return false;
        }
        Adausdt rhs = ((Adausdt) other);

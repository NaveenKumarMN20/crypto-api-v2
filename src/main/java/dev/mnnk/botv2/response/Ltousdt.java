...
public class Ltousdt {
    ...
    public Ltousdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Ltousdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Ltousdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Ltousdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Ltousdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Ltousdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Ltousdt withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Ltousdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ltousdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Ltousdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Ltousdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Ltousdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Ltousdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ltousdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ltousdt) == false) {
            return false;
        }
        Ltousdt rhs = ((Ltousdt) other);

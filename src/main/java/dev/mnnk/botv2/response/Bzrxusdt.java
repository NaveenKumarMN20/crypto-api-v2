...
public class Bzrxusdt {
    ...
    public Bzrxusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Bzrxusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Bzrxusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Bzrxusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Bzrxusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Bzrxusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Bzrxusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Bzrxusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Bzrxusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Bzrxusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Bzrxusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Bzrxusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Bzrxusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Bzrxusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bzrxusdt) == false) {
            return false;
        }
        Bzrxusdt rhs = ((Bzrxusdt) other);

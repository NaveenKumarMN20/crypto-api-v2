...
public class Oneusdt {
    ...
    public Oneusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Oneusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Oneusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Oneusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Oneusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Oneusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Oneusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Oneusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Oneusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Oneusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Oneusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Oneusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Oneusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Oneusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Oneusdt) == false) {
            return false;
        }
        Oneusdt rhs = ((Oneusdt) other);

...
public class Hntusdt {
    ...
    public Hntusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Hntusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Hntusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Hntusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Hntusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Hntusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Hntusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Hntusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Hntusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Hntusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Hntusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Hntusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Hntusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Hntusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Hntusdt) == false) {
            return false;
        }
        Hntusdt rhs = ((Hntusdt) other);

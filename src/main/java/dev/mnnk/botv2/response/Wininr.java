...
public class Wininr {
    ...
    public Wininr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Wininr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Wininr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Wininr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Wininr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Wininr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Wininr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Wininr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Wininr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Wininr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Wininr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Wininr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Wininr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Wininr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Wininr) == false) {
            return false;
        }
        Wininr rhs = ((Wininr) other);

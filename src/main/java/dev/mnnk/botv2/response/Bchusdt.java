...
public class Bchusdt {
    ...
    public Bchusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Bchusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Bchusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Bchusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Bchusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Bchusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Bchusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Bchusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Bchusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Bchusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Bchusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Bchusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Bchusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Bchusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bchusdt) == false) {
            return false;
        }
        Bchusdt rhs = ((Bchusdt) other);

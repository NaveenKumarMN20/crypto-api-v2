...
public class Steemusdt {
    ...
    public Steemusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Steemusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Steemusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Steemusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Steemusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Steemusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Steemusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Steemusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Steemusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Steemusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Steemusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Steemusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Steemusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Steemusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Steemusdt) == false) {
            return false;
        }
        Steemusdt rhs = ((Steemusdt) other);

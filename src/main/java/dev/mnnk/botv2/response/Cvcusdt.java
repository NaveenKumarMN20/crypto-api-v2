...
public class Cvcusdt {
    ...
    public Cvcusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Cvcusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Cvcusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Cvcusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Cvcusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Cvcusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Cvcusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Cvcusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Cvcusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Cvcusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Cvcusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Cvcusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Cvcusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Cvcusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cvcusdt) == false) {
            return false;
        }
        Cvcusdt rhs = ((Cvcusdt) other);

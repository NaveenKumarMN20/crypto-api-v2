...
public class Dgbinr {
    ...
    public Dgbinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Dgbinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Dgbinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Dgbinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Dgbinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Dgbinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Dgbinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Dgbinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Dgbinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Dgbinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Dgbinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Dgbinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Dgbinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Dgbinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dgbinr) == false) {
            return false;
        }
        Dgbinr rhs = ((Dgbinr) other);

...
public class Rsrusdt {
    ...
    public Rsrusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Rsrusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Rsrusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Rsrusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Rsrusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Rsrusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Rsrusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Rsrusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Rsrusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Rsrusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Rsrusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Rsrusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Rsrusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Rsrusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Rsrusdt) == false) {
            return false;
        }
        Rsrusdt rhs = ((Rsrusdt) other);

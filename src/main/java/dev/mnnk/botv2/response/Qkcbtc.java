...
public class Qkcbtc {
    ...
    public Qkcbtc withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Qkcbtc withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Qkcbtc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Qkcbtc) == false) {
            return false;
        }
        Qkcbtc rhs = ((Qkcbtc) other);

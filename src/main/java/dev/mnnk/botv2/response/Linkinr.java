...
public class Linkinr {
    ...
    public Linkinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Linkinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Linkinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Linkinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Linkinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Linkinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Linkinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Linkinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Linkinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Linkinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Linkinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Linkinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Linkinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Linkinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Linkinr) == false) {
            return false;
        }
        Linkinr rhs = ((Linkinr) other);

...
public class Dogewrx {
    ...
    public Dogewrx withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Dogewrx withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Dogewrx withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Dogewrx withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Dogewrx withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Dogewrx withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Dogewrx withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Dogewrx withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Dogewrx withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Dogewrx withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Dogewrx withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Dogewrx withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Dogewrx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Dogewrx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dogewrx) == false) {
            return false;
        }
        Dogewrx rhs = ((Dogewrx) other);

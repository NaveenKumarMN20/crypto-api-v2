...
public class Pundixusdt {
    ...
    public Pundixusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Pundixusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Pundixusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Pundixusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Pundixusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Pundixusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Pundixusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Pundixusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Pundixusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Pundixusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Pundixusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Pundixusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Pundixusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Pundixusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pundixusdt) == false) {
            return false;
        }
        Pundixusdt rhs = ((Pundixusdt) other);

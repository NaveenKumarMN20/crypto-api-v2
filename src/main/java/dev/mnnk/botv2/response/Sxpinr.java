...
public class Sxpinr {
    ...
    public Sxpinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Sxpinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Sxpinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Sxpinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Sxpinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Sxpinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Sxpinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Sxpinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Sxpinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Sxpinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Sxpinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Sxpinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Sxpinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sxpinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sxpinr) == false) {
            return false;
        }
        Sxpinr rhs = ((Sxpinr) other);

...
public class Firousdt {
    ...
    public Firousdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Firousdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Firousdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Firousdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Firousdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Firousdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Firousdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Firousdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Firousdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Firousdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Firousdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Firousdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Firousdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Firousdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Firousdt) == false) {
            return false;
        }
        Firousdt rhs = ((Firousdt) other);

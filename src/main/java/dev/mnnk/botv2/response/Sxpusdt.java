...
public class Sxpusdt {
    ...
    public Sxpusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Sxpusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Sxpusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Sxpusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Sxpusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Sxpusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Sxpusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Sxpusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Sxpusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Sxpusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Sxpusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Sxpusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Sxpusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sxpusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sxpusdt) == false) {
            return false;
        }
        Sxpusdt rhs = ((Sxpusdt) other);

...
public class Reninr {
    ...
    public Reninr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Reninr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Reninr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Reninr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Reninr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Reninr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Reninr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Reninr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Reninr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Reninr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Reninr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Reninr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Reninr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Reninr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Reninr) == false) {
            return false;
        }
        Reninr rhs = ((Reninr) other);

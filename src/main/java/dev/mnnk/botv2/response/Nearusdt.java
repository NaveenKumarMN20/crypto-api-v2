...
public class Nearusdt {
    ...
    public Nearusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Nearusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Nearusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Nearusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Nearusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Nearusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Nearusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Nearusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Nearusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Nearusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Nearusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Nearusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Nearusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Nearusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nearusdt) == false) {
            return false;
        }
        Nearusdt rhs = ((Nearusdt) other);

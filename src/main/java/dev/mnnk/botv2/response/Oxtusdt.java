...
public class Oxtusdt {
    ...
    public Oxtusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Oxtusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Oxtusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Oxtusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Oxtusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Oxtusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Oxtusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Oxtusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Oxtusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Oxtusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Oxtusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Oxtusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Oxtusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Oxtusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Oxtusdt) == false) {
            return false;
        }
        Oxtusdt rhs = ((Oxtusdt) other);

...
public class Etcinr {
    ...
    public Etcinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Etcinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Etcinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Etcinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Etcinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Etcinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Etcinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Etcinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Etcinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Etcinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Etcinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Etcinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Etcinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Etcinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Etcinr) == false) {
            return false;
        }
        Etcinr rhs = ((Etcinr) other);

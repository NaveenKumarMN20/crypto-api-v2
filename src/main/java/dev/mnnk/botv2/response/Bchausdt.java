...
public class Bchausdt {
    ...
    public Bchausdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Bchausdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Bchausdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Bchausdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Bchausdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Bchausdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Bchausdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Bchausdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Bchausdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Bchausdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Bchausdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Bchausdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Bchausdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Bchausdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bchausdt) == false) {
            return false;
        }
        Bchausdt rhs = ((Bchausdt) other);

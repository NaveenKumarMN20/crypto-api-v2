...
public class Maticbtc {
    ...
    public Maticbtc withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Maticbtc withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Maticbtc withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Maticbtc withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Maticbtc withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Maticbtc withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Maticbtc withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Maticbtc withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Maticbtc withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Maticbtc withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Maticbtc withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Maticbtc withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Maticbtc withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Maticbtc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Maticbtc) == false) {
            return false;
        }
        Maticbtc rhs = ((Maticbtc) other);

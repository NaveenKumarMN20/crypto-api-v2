...
public class Perlusdt {
    ...
    public Perlusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Perlusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Perlusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Perlusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Perlusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Perlusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Perlusdt withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Perlusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Perlusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Perlusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Perlusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Perlusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Perlusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Perlusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Perlusdt) == false) {
            return false;
        }
        Perlusdt rhs = ((Perlusdt) other);

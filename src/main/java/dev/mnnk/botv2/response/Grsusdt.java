...
public class Grsusdt {
    ...
    public Grsusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Grsusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Grsusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Grsusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Grsusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Grsusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Grsusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Grsusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Grsusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Grsusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Grsusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Grsusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Grsusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Grsusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Grsusdt) == false) {
            return false;
        }
        Grsusdt rhs = ((Grsusdt) other);

...
public class Btgusdt {
    ...
    public Btgusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Btgusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Btgusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Btgusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Btgusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Btgusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Btgusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Btgusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Btgusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Btgusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Btgusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Btgusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Btgusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Btgusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Btgusdt) == false) {
            return false;
        }
        Btgusdt rhs = ((Btgusdt) other);

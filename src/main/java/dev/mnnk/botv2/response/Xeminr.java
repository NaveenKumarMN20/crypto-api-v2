...
public class Xeminr {
    ...
    public Xeminr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Xeminr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Xeminr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Xeminr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Xeminr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Xeminr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Xeminr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Xeminr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Xeminr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Xeminr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Xeminr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Xeminr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Xeminr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Xeminr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Xeminr) == false) {
            return false;
        }
        Xeminr rhs = ((Xeminr) other);

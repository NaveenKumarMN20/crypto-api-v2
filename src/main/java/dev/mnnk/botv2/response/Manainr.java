...
public class Manainr {
    ...
    public Manainr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Manainr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Manainr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Manainr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Manainr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Manainr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Manainr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Manainr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Manainr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Manainr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Manainr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Manainr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Manainr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Manainr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Manainr) == false) {
            return false;
        }
        Manainr rhs = ((Manainr) other);

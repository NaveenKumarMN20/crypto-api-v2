...
public class Maticusdt {
    ...
    public Maticusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Maticusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Maticusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Maticusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Maticusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Maticusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Maticusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Maticusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Maticusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Maticusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Maticusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Maticusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Maticusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Maticusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Maticusdt) == false) {
            return false;
        }
        Maticusdt rhs = ((Maticusdt) other);

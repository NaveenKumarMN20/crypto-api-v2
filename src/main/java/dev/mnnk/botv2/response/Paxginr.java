...
public class Paxginr {
    ...
    public Paxginr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Paxginr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Paxginr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Paxginr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Paxginr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Paxginr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Paxginr withOpen(String open) {
        this.open = open;
        return this;
    }
    ...
    public Paxginr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Paxginr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Paxginr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Paxginr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Paxginr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Paxginr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Paxginr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Paxginr) == false) {
            return false;
        }
        Paxginr rhs = ((Paxginr) other);

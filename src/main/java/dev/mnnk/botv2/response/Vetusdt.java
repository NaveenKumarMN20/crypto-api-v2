...
public class Vetusdt {
    ...
    public Vetusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Vetusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Vetusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Vetusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Vetusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Vetusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Vetusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Vetusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Vetusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Vetusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Vetusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Vetusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Vetusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Vetusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Vetusdt) == false) {
            return false;
        }
        Vetusdt rhs = ((Vetusdt) other);

...
public class Datausdt {
    ...
    public Datausdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Datausdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Datausdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Datausdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Datausdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Datausdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Datausdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Datausdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Datausdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Datausdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Datausdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Datausdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Datausdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Datausdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Datausdt) == false) {
            return false;
        }
        Datausdt rhs = ((Datausdt) other);

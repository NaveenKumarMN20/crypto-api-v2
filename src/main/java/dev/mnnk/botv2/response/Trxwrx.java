...
public class Trxwrx {
    ...
    public Trxwrx withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Trxwrx withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Trxwrx withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Trxwrx withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Trxwrx withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Trxwrx withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Trxwrx withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Trxwrx withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Trxwrx withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Trxwrx withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Trxwrx withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Trxwrx withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Trxwrx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Trxwrx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Trxwrx) == false) {
            return false;
        }
        Trxwrx rhs = ((Trxwrx) other);

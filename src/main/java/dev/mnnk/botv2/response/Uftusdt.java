...
public class Uftusdt {
    ...
    public Uftusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Uftusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Uftusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Uftusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Uftusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Uftusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Uftusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Uftusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Uftusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Uftusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Uftusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Uftusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Uftusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Uftusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Uftusdt) == false) {
            return false;
        }
        Uftusdt rhs = ((Uftusdt) other);

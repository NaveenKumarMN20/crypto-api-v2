...
public class Vibusdt {
    ...
    public Vibusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Vibusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Vibusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Vibusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Vibusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Vibusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Vibusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Vibusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Vibusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Vibusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Vibusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Vibusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Vibusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Vibusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Vibusdt) == false) {
            return false;
        }
        Vibusdt rhs = ((Vibusdt) other);

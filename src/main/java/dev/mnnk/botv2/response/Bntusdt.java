...
public class Bntusdt {
    ...
    public Bntusdt withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Bntusdt withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Bntusdt withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Bntusdt withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Bntusdt withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Bntusdt withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Bntusdt withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Bntusdt withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Bntusdt withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Bntusdt withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Bntusdt withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Bntusdt withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Bntusdt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Bntusdt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bntusdt) == false) {
            return false;
        }
        Bntusdt rhs = ((Bntusdt) other);

...
public class Bttinr {
    ...
    public Bttinr withBaseUnit(String baseUnit) {
        this.baseUnit = baseUnit;
        return this;
    }
    ...
    public Bttinr withQuoteUnit(String quoteUnit) {
        this.quoteUnit = quoteUnit;
        return this;
    }
    ...
    public Bttinr withLow(String low) {
        this.low = low;
        return this;
    }
    ...
    public Bttinr withHigh(String high) {
        this.high = high;
        return this;
    }
    ...
    public Bttinr withLast(String last) {
        this.last = last;
        return this;
    }
    ...
    public Bttinr withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Bttinr withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public Bttinr withVolume(String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Bttinr withSell(String sell) {
        this.sell = sell;
        return this;
    }
    ...
    public Bttinr withBuy(String buy) {
        this.buy = buy;
        return this;
    }
    ...
    public Bttinr withAt(Integer at) {
        this.at = at;
        return this;
    }
    ...
    public Bttinr withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Bttinr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Bttinr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("baseUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bttinr) == false) {
            return false;
        }
        Bttinr rhs = ((Bttinr) other);
